...
import (
	...
	"gitlab.com/project-emco/core/emco-base/src/workflowmgr/pkg/infra/auth"
	"gitlab.com/project-emco/core/emco-base/src/workflowmgr/pkg/infra/config"
...
func main() {
	...
	*/
	...
	log.Println("HTTP server returned error: %s", err)
}
