...
import (
	...
	contextpb "gitlab.com/project-emco/core/emco-base/src/workflowmgr/pkg/grpc/contextupdate"
...
func (cs *contextupdateServer) UpdateAppContext(ctx context.Context, req *contextpb.ContextUpdateRequest) (*contextpb.ContextUpdateResponse, error) {
	...
	err := error(nil) // action.UpdateAppContext(req.IntentName, req.AppContext)
