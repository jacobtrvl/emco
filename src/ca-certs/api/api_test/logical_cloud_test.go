...
// 	Items []logicalcloud.LogicalCloud
// 	Err   error
// }

// func init() {
// 	// api.LogicalCloudSchemaJson = "../json-schemas/certificate.json"
// 	api.LogicalCloudSchemaJson = "C:\\Users\\subinjoh\\OneDrive - Intel Corporation\\Desktop\\Intel\\emco\\dev\\emco-base\\src\\ca-certs\\json-schemas\\logicalCloud.json"
// }

// func (m *mockLogicalCloudManager) CreateLogicalCloud(logicalCloud logicalcloud.LogicalCloud, cert, project string, failIfExists bool) (logicalcloud.LogicalCloud, bool, error) {
// 	iExists := false
// 	index := 0

// 	if m.Err != nil {
// 		return logicalcloud.LogicalCloud{}, iExists, m.Err
// 	}
...
// 		return logicalcloud.LogicalCloud{}, iExists, errors.New("LogicalCloud already exists")
// 	}
...
// 			m.Items[len(m.Items)-1] = logicalcloud.LogicalCloud{}
...
// func (m *mockLogicalCloudManager) GetAllLogicalClouds(cert, project string) ([]logicalcloud.LogicalCloud, error) {
// 	if m.Err != nil {
// 		return []logicalcloud.LogicalCloud{}, m.Err
// 	}

// 	var certs []logicalcloud.LogicalCloud
// 	certs = append(certs, m.Items...)

// 	return certs, nil

// }
// func (m *mockLogicalCloudManager) GetLogicalCloud(logicalCloud, cert, project string) (logicalcloud.LogicalCloud, error) {
// 	if m.Err != nil {
// 		return logicalcloud.LogicalCloud{}, m.Err
// 	}
...
// 	return logicalcloud.LogicalCloud{}, errors.New("LogicalCloud not found")
// }
...
// 					result:     logicalcloud.LogicalCloud{},
// 					err:        errors.New("logicalCloud name may not be empty\n"),
...
// func populateLogicalCloudTestData() []logicalcloud.LogicalCloud {
...
// 			},
// 			Spec: logicalcloud.LogicalCloudSpec{
// 				Name: "lc1",
// 			},
// 		},
// 		{
...
// func logicalCLoudResult(name string) logicalcloud.LogicalCloud {
// 	return logicalcloud.LogicalCloud{
// 		MetaData: module.MetaData{
// 			Name:        name,
// 			Description: "test logicalCloud",
...
// 	result := t.result.(logicalcloud.LogicalCloud)

// 	lc := logicalcloud.LogicalCloud{}
