...
// func init() {
// 	// api.ClusterSchemaJson = "../json-schemas/module.json"
// 	api.ClusterSchemaJson = "C:\\Users\\subinjoh\\OneDrive - Intel Corporation\\Desktop\\Intel\\emco\\dev\\emco-base\\src\\ca-certs\\json-schemas\\module.json"
// }
...
// 		if item.MetaData.Name == module.MetaData.Name {
// 			iExists = true
// 			index = i
// 			break
// 		}
