...
// func (m *mockClusterProviderCertManager) CreateCert(cert module.Cert, clusterProvider string, failIfExists bool) (module.Cert, bool, error) {
// 	iExists := false
// 	index := 0
...
// func (m *mockClusterProviderCertManager) GetAllCert(clusterProvider string) ([]module.Cert, error) {
// 	if m.Err != nil {
...
// }
// func (m *mockClusterProviderCertManager) GetCert(cert, clusterProvider string) (module.Cert, error) {
// 	if m.Err != nil {
// 		return module.Cert{}, m.Err
// 	}
