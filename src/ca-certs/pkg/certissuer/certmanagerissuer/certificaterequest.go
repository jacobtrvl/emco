...
func CreateCertificateRequest(caCert module.Cert, name string, request []byte) (*CertificateRequest, error) {
	...
	cr.MetaData = CertificateRequestMeta{
		Name: name}
	cr.Spec = CertificateRequestSpec{
...
func RetrieveCertificateRequests(contextID string) ([]CertificateRequest, error) {
	...
	var (
		...
		certificateRequestStatuses []CertificateRequest
		clusters                   []string
		certificateRequestList     []CertificateRequest
	)
	// load the appContext
