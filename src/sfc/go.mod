...
replace (
	...
	// k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20210421082810-95288971da7e k8s.io/kube-openapi/pkg/validation/spec
...
require (
	github.com/akraino-edge-stack/icn-nodus v0.0.0-20211213022516-8e44aa156291
