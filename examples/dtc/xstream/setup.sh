...
XSTREAM_SERVER_IMAGE_REPOSITORY=${XSTREAM_SERVER_IMAGE_REPOSITORY:-<docker-registry-url>/xstream-server}
XSTREAM_CLIENT_IMAGE_REPOSITORY=${XSTREAM_CLIENT_IMAGE_REPOSITORY:-<docker-registry-url>/xstream-client}
